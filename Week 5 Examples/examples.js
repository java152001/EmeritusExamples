...
const arrayExample2 = [1,3,5,378,183,348,48,4785,6];

const sliceElement = (givenArray, splitLength) => {

    const givenLength = givenArray.length; // 6
    const start = givenLength - splitLength; // 6 - 3 = 3

    return givenArray.slice(start, givenLength);

    // givenArray.slice(3, 6)
}

// console.log(sliceElement(arrayExample, 3)); //[41, 3, 17]
console.log(sliceElement(arrayExample2, 5));

/*** Example 2 Splicing ***/

// const arrayExample2 = [4,18,25,"Otters", true, 3.1415, 21, "Giraffes"];

// const spliceElements = (givenArray, spliceLength, thingsToAdd) => {
    
//     const givenLength = givenArray.length;
//     const start = givenLength - 1;  // 8 - 1 = 7
...
// console.log(spliceElements(arrayExample2, 1, "Roger Roger"));
...
//     const returnArray = givenString.split(splitter);
...
// console.log(superMegaSplitter(stringExample, '_')); //[NextTech, is, my, favorite thing]
// console.log(superMegaSplitter(stringExample, ' ')); //[NextTech_is_my_favorite, thing]
// console.log(superMegaSplitter(stringExample, 't')); // [N, xtT, ch_is_my_favorit,  thing]
